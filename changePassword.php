...
<form class="bg-light container center_div rounded shadow-sm col-md-3 ml-auto" method="POST" action=<?php echo "index.php?uc=update&action=updatePassword&id=".$id.""?>>
